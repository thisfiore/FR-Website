		...
		<ul>
			...
			<li class="openpolli no_list" data-placement="bottom" data-trigger="hover" data-content="" data-original-title="" title="">
						...
						<div 
							...
							<h3><img src="/img/producer-icon-alt.png" width="18"> <a data-id_produttore="#produttore<?php echo $riservato['id_produttore']?>"><?php echo $riservato['nome_produttore']?></a></h3>
